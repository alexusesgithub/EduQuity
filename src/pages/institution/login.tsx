...
const InstitutionLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mockUser = {
        id: 'user-1',
        name: formData.role === 'teacher' ? 'Prof. Jane Smith' : 'Alex Student',
      ...
      localStorage.setItem('institution_user', JSON.stringify(mockUser));
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center">
      <Head>
        <title>Institution Login | Education Equity System</title>
      </Head>
      
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900">Institution Portal</h2>
